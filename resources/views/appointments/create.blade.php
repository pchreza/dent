...
<section class="card card--wide">
    <form method="post" action="{{ route('appointments.store') }}" class="form-grid" novalidate>
        ...
        <div class="field-grid">
            ...
            <div class="field"><label for="title">عنوان نوبت *</label><input id="title" name="title" value="{{ old('title', 'ویزیت/درمان') }}" required></div>
            ...
            <div class="field"><label for="starts_at">شروع *</label><input id="starts_at" type="datetime-local" name="starts_at" value="{{ old('starts_at') }}" required dir="ltr"></div>
            <div class="field"><label for="ends_at">پایان *</label><input id="ends_at" type="datetime-local" name="ends_at" value="{{ old('ends_at') }}" required dir="ltr"></div>
