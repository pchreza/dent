...
فاز پروندهٔ دندان‌پزشکی پیشرفته شامل فیلدهای سفارشی پرونده، نمودار FDI برای دندان‌های دائمی و شیری، تاریخچهٔ افزایشی وضعیت دندان و طرح درمان چندآیتمی متصل به دندان/سطح، مرحله، اولویت و هزینه است. در بازطراحی 0.3.0، نمودار به یک **اودونتوگرام کامل مبتنی بر SVG** تبدیل شده است: تصویر یکپارچهٔ فک بالا و پایین، لایهٔ لثه و استخوان، سیلوئت متفاوت دندان‌ها، نام آناتومیک فارسی، FDI ایزولهٔ LTR، وضعیت‌های رنگی و سطح‌های بالینی.

نمای پیش‌فرض فقط دندان‌های دارای رخداد یا طرح درمان را نشان می‌دهد؛ دندان‌های بدون سابقه پنهان هستند و تعداد آن‌ها اعلام می‌شود. کاربر می‌تواند نمای کامل دندان‌های دائمی یا شیری را جداگانه باز کند. با انتخاب هر دندان، پنل «داستان درمان دندان» بدون Refresh وضعیت فعلی، سطح‌ها، Timeline بالینی، Stepper درمان، اقدام بعدی و ثبت سریع را نمایش می‌دهد. CTA افزودن به طرح درمان، کد دندان و سطح انتخاب‌شده را در فرم آیتم اول پیش‌انتخاب می‌کند. گزارش بازبینی بصری در [`docs/qa/jaw-odontogram-visual-findings.md`](docs/qa/jaw-odontogram-visual-findings.md)، گزارش QA فاز در [`docs/qa/phase-6-report-fa.md`](docs/qa/phase-6-report-fa.md) و طراحی فنی در [`docs/product/phase-6-advanced-clinical-record-fa.md`](docs/product/phase-6-advanced-clinical-record-fa.md) قرار دارد.

فایل پزشکی، نسخه‌نویسی، اتصال واقعی IPPanel/SMS، ایمیل، درگاه پرداخت، پورتال کامل بیمار، گزارش‌ساز پیشرفته، Queue تولیدی و Upgrade Center در Backlog نسخه‌های بعدی قرار دارند.
...
هر فاز فقط پس از تست، رفع خطا، Regression و گزارش QA قابل قبول است. برای بازبینی اودونتوگرام، حالت‌های «فقط دندان‌های فعال»، «همهٔ دندان‌های دائمی» و «همهٔ دندان‌های شیری» و انتخاب دندان دارای روند درمان نیز باید بررسی شوند.
