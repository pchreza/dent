...
فاز پروندهٔ دندان‌پزشکی پیشرفته اکنون شامل فیلدهای سفارشی پرونده، نمودار دندان FDI برای دندان‌های دائمی و شیری، تاریخچهٔ افزایشی وضعیت دندان و طرح درمان چندآیتمی متصل به دندان/سطح، مرحله، اولویت و هزینه است. نمودار دندان به‌صورت گرافیکی با شکل SVG دندان، تفکیک فک بالا/پایین، legend فارسی، کارت‌های آماری و انتخاب تعاملی کار می‌کند؛ با انتخاب هر دندان، کد آن در فرم ثبت قرار می‌گیرد و آخرین وضعیت به‌صورت زنده نمایش داده می‌شود. گزارش QA این فاز در [`docs/qa/phase-6-report-fa.md`](docs/qa/phase-6-report-fa.md)، گزارش بازبینی بصری در [`docs/qa/graphic-chart-visual-findings.md`](docs/qa/graphic-chart-visual-findings.md) و طراحی فنی در [`docs/product/phase-6-advanced-clinical-record-fa.md`](docs/product/phase-6-advanced-clinical-record-fa.md) قرار دارد.
